...
echo 'BOOTPROTO=none' >> /etc/sysconfig/network-scripts/ifcfg-enp0s3
...
echo "IPADDR=172.20.10.2" >> /etc/sysconfig/network-scripts/ifcfg-enp0s3
echo 'NETMASK=255.255.255.0' >> /etc/sysconfig/network-scripts/ifcfg-enp0s3
echo 'IPV6INIT=no' >> /etc/sysconfig/network-scripts/ifcfg-enp0s3
...
echo 'NAME=enp0s3' >> /etc/sysconfig/network-scripts/ifcfg-enp0s3
echo 'UUID=141a5b86-f665-4bbc-8678-d96b6df0cc98' >> /etc/sysconfig/network-scripts/ifcfg-enp0s3
